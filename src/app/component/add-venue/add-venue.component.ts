...
export class AddVenueComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.addVenueForm = this.formBuilder.group({
      venueType: ['Gym', Validators.required],
      venueName: ['Strong People', Validators.required],
      streetName: ['Silna', Validators.required],
      streetNumber: ['70', Validators.required],
      city: ['Wroclaw', Validators.required],
      postcode: ['50-500', Validators.required],
      country: ['Poland', Validators.required],
      description: ['Very nice gym!', Validators.required],
    ...
    this.daysOfWeek.forEach((day) => {
      this.openingHoursArray.push(this.formBuilder.group({
        dayOfWeek: [day],
        openFrom: ['6', Validators.required],
        openTo: ['20', Validators.required],
...
//TODO: update edit mode when changing opening hours
  onSubmit() {
